...
onMounted(() => {
    var options = {
        ...
        labels: ['Calories', 'Exercise', 'Sleep'],
    };
                        ...
                        <div class="container-fluid dsb d-flex align-items-center">
                            <div class="card box  d-flex justify-content-center align-items-center">
                                <svg viewBox="-0.5 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" fill="white" width="32">
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                            ...
                                            <path
                                                ...
                                                id="Person" stroke="#6B6C6E" stroke-width="2" sketch:type="MSShapeGroup">
                                            </path>
                                        </g>
                                    </g>
                                </svg>
