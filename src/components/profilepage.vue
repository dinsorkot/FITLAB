    ...
    <div class="container">
        <div class="container profile profile-user d-flex align-items-center position-relative">
            ...
            <div class="ps-3 text-light">
                <h1>{{ usm.username }} ({{ usm.age }})</h1>
                <h4>{{ usm.sex }}</h4>
                <h6>{{ usm.weight }} (kg) , {{ usm.height }} (cm)</h6>
            </div>
            <div class="position-absolute top-0 end-0 me-3 mt-2 edit">
        ...
        <div class="posted post-user mt-3 position-relative" v-for="post in postedsUser" :key="post.uid">
            <div class="d-flex">
                <div class="card box-us box-user d-flex justify-content-center align-items-center">
                    <svg viewBox="-0.5 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"
                        fill="white" width="32">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
